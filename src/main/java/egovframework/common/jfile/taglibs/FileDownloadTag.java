...
public class FileDownloadTag extends TagSupport
{
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			StringBuilder bf = new StringBuilder().append("<script>")
	...
	/**
	 * 보안 적용 암.호.화. 여부 값을 반환
	 * @return String 보안 적용 암.호.화. 여부 값
	 */
	...
	/**
	 * 보안 적용 암.호.화. 여부 값을 세팅
	 * @param useSecurity 보안 적용 암.호.화. 여부 값 
	 */
