...
public class EgovStringUtil {
	 ...
	 * @see
	 */
	public static String getRandomStr(char startChr, char endChr) throws RuntimeException
	{
		int randomInt;
     ...
     * @see
     */
	public static String getSpclStrCnvr(String srcString) throws RuntimeException
	{
		String rtnStr = null;
	 ...
	 * @see
	 */
	public static String getTimeStamp() throws RuntimeException
	{
		String rtnStr = null;
