...
public class EgovFormBasedFileVo implements Serializable {
    ...
    /** 썸네일 물리적 파일명 */
    private String physicalThumName = "";
    /** 파일 사이즈 */
	...
	public String getPhysicalThumName() {
		return physicalThumName;
	}
	public void setPhysicalThumName(String physicalThumName) {
		this.physicalThumName = physicalThumName;
	}
