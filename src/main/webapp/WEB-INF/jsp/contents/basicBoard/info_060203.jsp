...
<script type="text/javascript">
	...
	function searchSite(){
		...
		var param = { ADM_CD:admCd, SEARCH_TYPE:_searchType, DO_TYPE:'v_ugrwtr_b' };
	...
	function searchWaterSys(){
		...
		var param = { WS_CD:getWsCd, AM_CD:getAmCd, SEARCH_TYPE:_searchType, DO_TYPE:'v_ugrwtr_b' };
	...
	function searchName(){
        ...
        _searchType = "5";
        var param = { ST_NM:getName, SEARCH_TYPE:_searchType, DO_TYPE:'v_ugrwtr_b' };
...
<form name="resultFrm" id="resultFrm" method="post">
	...
	<input type="hidden" id="mId" name="mId" value ="ExcelAfterWaterObserve"/>
