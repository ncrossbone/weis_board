...
<script type="text/javascript">
	...
	function searchSite(){
		...
		var param = { TYPE_CD:getSiteType, ADM_CD:admCd, SEARCH_TYPE:searchType, DO_TYPE:'boobsif' };
	...
	function searchWaterSys(){
		...
		var param = { TYPE_CD:getSiteType, WS_CD:getWsCd, AM_CD:getAmCd, SEARCH_TYPE:searchType, DO_TYPE:'boobsif' };
	...
	function searchName(){
        ...
        var searchType = "5";
        var param = { TYPE_CD:getSiteType, ST_NM:getName, SEARCH_TYPE:searchType, DO_TYPE:'boobsif' };
...
<form name="resultFrm" id="resultFrm">
	...
	<input type="hidden" id="mId" name="mId" value ="ExcelfsSuccor"/>
			...
			<c:if test="${not empty resultList}">
				<c:forEach var="item" items="${resultList}" varStatus="idx">
					<tr>
						...
						<td>${item.ADDR }</td>
						<td>${item.AM_NM }</td>
						<td>${item.RLIF_ACT_DE }</td>
						<td>${item.RLIF_FISHES_CO }</td>
						<td>${item.RLIF_SHELFISH_CO }</td>
