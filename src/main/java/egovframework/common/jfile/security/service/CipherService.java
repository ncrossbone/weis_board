package egovframework.common.jfile.security.service;
...
public interface CipherService {
	...
	/**
	 * byte[] 타입의 데이타를 암.호.화. 한다.
	 * @param data 데이타.
	 * @return byte[] 암.호.화. 된 데이타.
	 * @throws NoSuchAlgorithmException 암.호.화. 알고리즘을 찾을 수 없을때 예외 처리
	...
	/**
	 * 입력스트림을 전달 받아 암.호.화. 하여 출력스트림으로 반환한다.
	 * @param in 입력스트림
	 * @param out 출력스트림
	 * @throws NoSuchAlgorithmException 암.호.화. 알고리즘을 찾을 수 없을때 예외 처리
	 * @throws InvalidKeyException 규칙에 맞지 않은 key 일때 예외 처리
	...
	/**
	 * 암.호.화.된 파일을 복호화 한 후 ZIP 으로 압축하여 반환한다.
	 * @param in 입력스트림
	 * @param out 출력스트림
	 * @throws NoSuchAlgorithmException 암.호.화. 알고리즘을 찾을 수 없을때 예외 처리
	 * @throws InvalidKeyException 규칙에 맞지 않은 key 일때 예외 처리
