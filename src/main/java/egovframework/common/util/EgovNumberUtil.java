...
public class EgovNumberUtil {
     ...
     * @see
     */
	public static int getRandomNum(int startNum, int endNum) throws RuntimeException
	{
		int randomNum = 0;
		// 랜덤 객체 생성
	 ...
	 * @see
	 */
	public static String getNumToStrCnvr(int srcNumber) throws RuntimeException
	{
		String rtnStr = null;
...
/*    public static String getNumToDateCnvr(int srcNumber) {
	...
	EgovDateUtil.formatDate(srcStr, "-");
	 ...
	 * @see
	 */
	public static Boolean getNumberValidCheck(String checkStr) throws RuntimeException
	{
     ...
     * @see
     */
	public static int getNumberCnvr(int srcNumber, int cnvrSrcNumber, int cnvrTrgtNumber) throws RuntimeException
	{
