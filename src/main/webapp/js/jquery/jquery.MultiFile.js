...
//							.replace(/\$(i)/gi, i)
						;
							...
							a = $('<span class="MultiFile-title" title="' + MultiFile.STRING.selected + '">'+ v +'</span>'),
//							c = $('<span class="MultiFile-export" style="float:left">'+MultiFile.STRING.text+'</span>'),
							b = $('<span class="MultiFile-remove"><a href="#'+MultiFile.wrapID+'" class="icn_fileDel">'+MultiFile.STRING.remove+'</a></span>')
								// ********
								// TODO:
...
//							r.append(b, ' ', c, ' ', a)
						...
						if($('#detailFileList'+MultiFile.STRING.idx).children('div').hasClass("MultiFile-label")){

							var	fileExpIndex = $('#detailFileList'+MultiFile.STRING.idx).children('.MultiFile-label:last');
							var fileExp = $('#detailFileList'+MultiFile.STRING.idx).children('.MultiFile-label').eq(fileExpIndex.index()).children('.MultiFile-export').find('.fileExp');
							//.children('.MultiFile-export').find('.fileExp')
