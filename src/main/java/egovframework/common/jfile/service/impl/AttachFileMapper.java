...
public class AttachFileMapper extends EgovAbstractMapper {
	...
	public String getFileId() {
		return selectOne("JFile.getFileId");
	}
	...
	public void addAttachFile(JFileDetails fileVo) {
		insert("JFile.addAttachFile", fileVo);
	}
	...
	public JFileVO selectAttachFile(final String fileId, final String fileSeq) {
		return selectOne("JFile.getAttachFileToMap", new HashMap<String, Object>(){{
			put("fileId", fileId);
			put("fileSeq", fileSeq);
		}});
	}
	...
	public List<JFileDetails> selectAttachFiles(final String fileId) {
		return selectList("JFile.getAttachFileToMap", new HashMap<String, Object>(){{
			put("fileId", fileId);
		}});
	}
	...
	public void updateAttachFileDeleteYnByFileId(final String fileId, final String deleteYn) {
		update("JFile.updateAttachFileDeleteYnByFileId", new HashMap<String, Object>(){{
			put("fileId", fileId);
	...
	public void updateAttachFileDownloadCount(final String fileId) {
		update("JFile.updateAttachFileDownloadCount", new HashMap<String, Object>(){{
			put("fileId", fileId);
		}});
	}
	...
	public void removeAttachFile(final String fileId, final List<Object> fileSeqs) {
		...
		delete("JFile.removeAttachFile", new HashMap<String, Object>(){{
			put("fileId", fileId);
	...
	public Object[] getAttachFileSeqs(String fileId) {
		...
		List<Object> list = selectList("JFile.getAttachFileSeqs", fileId);
	...
	public void updateAttachFileDeleteYn(final String fileId, final Object[] fileSeqs, final String deleteYn) {
		...
		if(fileId == null || fileSeqs == null)
			return;
		update("JFile.updateAttachFileDeleteYn", new HashMap<String, Object>(){{
			put("fileId", fileId);
	...
	public boolean isExistingAttachFileInfo(final String fileId, final List<Object> fileSeqs) {
		...
		return selectList("JFile.isExistingAttachFileInfo", paramMap).size() != 0;
	}
	...
	public void updateAttachFileDownloadCountBySequence(final String fileId, final String fileSeq) {
		update("JFile.updateAttachFileDownloadCountBySequence", new HashMap<String ,Object>(){{
			put("fileId", fileId);
			put("fileSeq", fileSeq);
		}});
	}
	...
	public void updateAttachFileDownloadCountByFileId(String fileId) {
		update("JFile.updateAttachFileDownloadCountByFileId", fileId);
	}
}
